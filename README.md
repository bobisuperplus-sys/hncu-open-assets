...
│
├── academics/                     # 【学术与备考资料】(12门课程历年真题试卷、7门核心课期末题库)
│   ├── README.md                  # 考试真题与复习资料全景索引指南
│   ├── past_exams/                # 历年期末官方真题 (共 20 份，涵盖通识数理课与专业核心课)
│   │   ├── 高等数学/ (A1、A2 历年真题试卷共 3 套)
│   │   ├── 线性代数/ (2021-2024 历年真题试卷共 3 套)
│   │   ├── 概率统计/、大学物理/、离散数学/ (通识基础课历年真题)
│   │   ├── 计算机网络/、计算机组成原理/、数据库原理/ (含逐题解析版真题)
│   │   └── 操作系统/、网络管理技术/、网络编程协议/、网络工程/
│   └── review_materials/          # 课程期末复习大纲与专项题库 (含逐题深度解析)
│       ├── C语言程序设计/ (易错题精解 + 8套期末模拟套卷及参考答案)
│       ├── 操作系统/ (302页全真题库 + 考试题型与考点说明)
│       ├── 计算机组成原理/ (期末核心冲刺题库含详细解析)
│       ├── 数据库原理/ (核心知识点精讲 + A卷解析版讲义)
│       ├── 网络工程/ (5套专业模块专项题库：排障/布线/DHCP/路由/华为命令)
│       ├── 入侵检测与防御技术/ (全套 6 份体系化复习资料包)
│       └── 防火墙技术/ (期末考前复习题库与安全区域考点)
│
├── branding/                      # 【品牌视觉与多媒体素材】
...
* **历年官方真题试卷 (`past_exams/`)**：
  * **通识数理基础课**：高等数学（A1、A2 历年真题共 3 套）、线性代数（2021～2024 连续 3 学年真题）、概率论与数理统计（2 套）、大学物理（下）、离散数学（2 套）。
...
* **期末复习题库与考点讲义 (`review_materials/`)**：
  * **C 语言程序设计**：期末易错题精讲 + 8 套完整的 Word 模拟试卷套卷（含全套选择、读程序与填空参考答案）。
  * **操作系统**：雨课堂 1-9 章全章节 **302 页超全题库** + 期末考试大纲与计算题重点说明。
  * **计算机组成原理**：14 页期末核心题库（含定点/浮点数、寻址与控制器大题深度解析）。
  * **数据库原理**：期末核心知识点精讲速记 + 期末试卷 A 卷 Markdown 解析讲义。
  * **网络工程专业课**：5 大专项模块刷题库（主机排障、综合布线、DHCP、动态路由协议、静态路由与华为配置命令）。
  * **网络安全方向**：入侵检测与防御技术全套 6 份体系化复习资料、防火墙技术及应用题库与安全区域考点。
